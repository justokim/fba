...
export const Founder = () => {
  ...
  return (
    <div className="pt-8 pb-28 bg-black/95 text-white">
      <h1 className="text-4xl font-bold text-center py-16 uppercase">
        Meet The Founder
      </h1>
        ...
        <div className="grid grid-cols-1 h-full gap-2 lg:grid lg:grid-cols-2 mt-6 place-items-center  ">
          ...
          <div className="col-span-1 h-full">
            <div className="flex flex-col h-full">
              <div className="text-white/80">{paragraphs[index]}</div>
                    ...
                    {paragraphs.map((_, idx) => (
                      <span
                        ...
                        className={`w-3 h-3 rounded-full cursor-pointer ${
                          index === idx ? "bg-orange-600" : "bg-white"
                        }`}
                      />
                    ))}
                  </div>
